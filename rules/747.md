...
#### § 747. Wet roots, except @[prach] which takes @[i] necessarily, and @[naś], @[sū] and @[dhū] which reject @[i], the five roots given under § 472 and the roots marked with an indicatory @[iṭ] admit of @[i] optionally before @[tvā] e. g.
