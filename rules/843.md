...
(b) The Ablative is used to make a causative assertion or to advance an argument; @[parvataḥ] @[vahnimān] @[dhūmāt] The mountain is fiery (has fire on it), because there is smoke; @[smṛtyanavalāśadoṣaprasaṅgaḥ] @[iti] @[cet] @[na] @[anyasmṛtyaṇavakāśadoṣaprasaṅgāt] (Ved. Su. II. 1, 1) A disputant says—if you say that our argument is liable to the fault of giving no scope to your smriti, then we reply: this your argument will not hold; for in that case other smritis will have no scope given to them.
