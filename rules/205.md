...
(b) with verbal derivatives when the Instrumental has the sense of the agent or the instrument or means of the action; as @[hariṇā] @[trātaḥ] @[haritrātaḥ] saved by Hari; @[nakhaiḥ] @[bhinnaḥ] @[nakhbhinnaḥ] tom with the nails &c.
...
father; @[māṣeṇa] @[ūnam] @[māṣonam]; so @[māṣikonam] (less by one @[māṣa], a particular weight); @[vākā] @[kalahaḥ] @[vākkalahaḥ] a quarrel (in words), @[ācāranipuṇaḥ]; @[guḍamiśraḥ], @[dharmavṛddhaḥ] 'thin by the discharge of religious duties' @[māsena] @[avaraḥ] @[māsāvaraḥ] 'younger by a month.'
