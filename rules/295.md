...
(c) when followed by @[tīrtha] with the Tad. affix @[ya] added to it; as @[samāne tīrthe vāsī satīrthyaḥ] 'a disciple of the same preceptor,' and optionally when followed by @[udara] under the same circumstances; @[samāne udare garbhitaḥ saudaraḥ] or @[samānodaryaḥ] 'bom of the same womb,' 'a brother by whole blood.'
