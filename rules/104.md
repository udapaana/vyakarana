...
#### § 104. Nouns derived form the root @[añc] 'to go' by means of such affixes as @[vat], @[van] &c. such as @[prāñc] (@[prā-añc]) eastern, @[pratyañc] (@[prati-añc]) western, @[samyañc] (@[sam-añc]) a companion, @[tiryañc] (@[tiras-añc]) going away, @[samyañc] (@[sam-añc]) going with or well, @[viṣvañc] (@[viṣu-añc]) following, @[devayañc] (@[dev-añc]) adoring a deity, @[sarvayañc] (@[sarva-añc]) going everywhere, @[udañc] northen, @[anvañc] following, @[udayañc], @[bhūyañc]; @[amuyañc] going to that (all these derived from @[adas] + @[añc]), @[prayañc] &c.
