...
#### § 4. The consonants are divided into sparśas or mutes (those involving a complete closure or contact and not an approximate one of the organs of pronunciation), Antasthā (or intermediate, the Semivowels,) and ūṣman or sibilants.

These are represented by thirty-three syllabic signs arranged as below:—

(1) @[कवर्ग] or the group @[कवर्ग]—@[क्] k, @[ख्] kh, @[ग्] g, @[घ्] gh, @[ङ्] ṅ.

(2) @[चवर्ग] or the group @[चवर्ग]—@[च्] c, @[छ्] ch, @[ज्] j, @[झ्] jh, @[ञ्] ñ.

(a) mutes (3) @[टवर्ग] or the group @[टवर्ग]—@[ट्] ṭ, @[ठ्] ṭh, @[ड्] ḍ, @[ढ्] ḍh, @[ण्] ṇ.

(4) @[तवर्ग] or the group @[तवर्ग]—@[त्] t, @[थ्] th, @[द्] d, @[ध्] dh, @[न्] n.

(5) @[पवर्ग] or the group @[पवर्ग]—@[प्] p, @[फ्] ph, @[ब्] b, @[भ्] bh, @[म्] m.
...
‡ Or six kinds only; so @[अ] means @[अ] and nothing else.
