...
#### § 812. † The Instrumental case primarily expresses either the agent (when the construction is passive) or the instrument or means by which an action is done. @[aho] @[mahimānaṃ] @[ajānatā] @[mayā] @[tvam] @[asi] @[avajñāsīḥ] thou wast disrespected by me, not knowing thy greatness;
