...
#### § 458. (a) Roots of more than one syllable, derived roots and roots of the 10th class are always @[seṭ].
...
i. e. roots ending in long @[ū] and long @[ṛ]; the roots @[su], @[ṇu], @[kū],

---

@[khyā], @[stu], @[ri], @[lī], @[khī], @[śī], @[ṣṇi], @[yi], @[dvi], @[ḍī], @[rū], @[bhī], @[bhṛ], @[id] cl. A. and @[añj] & @[jñā] cl. P. A. are @[seṭ] (excepting these, all monosyllabic roots ending in a vowel are @[aniṭ]).
