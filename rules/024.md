...
#### § 24. @[e], @[o], @[ai] and @[au], when followed by a vowel, are changed to @[ay], @[av], @[āy], and @[āv] respectively; e. g. @[hare] + @[e] = @[haraye] for Hari; @[viṣṇo] + @[e] = @[viṣṇave] for Viṣṇu; @[nai] + @[akaḥ] = @[nāyakaḥ] A leader, @[pau] + @[akaḥ] = @[pāvakaḥ] the purifier i. e. fire.
