...
#### § 766. The gerund in @[am] of the root @[kṛ] is used:
...
(c) with the words @[anyathā], @[evam], @[ittham], and @[katham], provided the root @[kṛ] loses its sense; @[anyathākāram vadati] 'he speaks in a different manner;' @[evakākāram bhukte] 'he eats thus:' similarly @[itthamkāra], @[kathamkāram], but @[śiro'nyathā vadati bhukte].
