...
#### § 504. The roots that reject @[iṭ] altogether in the perfect—
...
† The @[ṛ] is changed to Guṇa as it is preceded by a conjunct consonant now (Vide § 499. Sid. Kau. on Pan VII. 1. 10-11.)

‡ The @[v] of the terminations @[dhaivam], @[dhvam], and @[va] of 2nd per. pl. of the benedictive, the aorist and the perfect, is changed to @[ḍh] when preceded by any vowel except @[a] or @[ā] or by @[y], @[r], @[h]. (Otherwise it is changed to @[ḍhv]).
