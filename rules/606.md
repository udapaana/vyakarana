...
'to call,' @[ah] 'to cover,' @[ve] 'to weave,' @[kṣai] 'to waste away,' and @[pā] 'to drink' insert @[p] instead of @[p]; @[śāpayati], @[cāyayati], @[vāyayati], @[dāpayati], &c.

(b) @[pā] 'to protect' and @[ve] when it means 'to shake,' insert @[lay] and @[j] respectively before @[ay]; @[pālayati] 'he protects,' @[vājayati] 'he shakes.'
