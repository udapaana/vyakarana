...
#### § 211. But (a) It is not compounded with verbal derivatives ending in @[tṛ] and @[aka] and denoting the agent of the action; @[odasya] @[kartā] and not @[odanakartā]; @[odasya] @[pācakaḥ] &c.; but @[indrasya] @[vajradhara] or @[vajradharaḥ] as the @[aka] here does not denote the agent.
...
(c) A noun in the Genitive is not compounded with ordinal numbers, words denoting qualities, words implying satisfaction, present participles, past participles meaning 'honoured or approved of' or showing the place of the act, verbal indeclinables and verbal nouns ending in @[tavya]; e.g. @[satāṃ] @[ṣaṣṭhaḥ], @[brāhmaṇasya] @[guṇaḥ] (@[guntaḥ]); @[kākasya] @[kāṇyam]; @[phalānāṃ] @[tṛptaḥ] 'satisfied with fruits' (an Inst. Tat. is, of course, allowed in these cases); @[dvijeṣu] @[kurvat] @[karuṇāṃ] वा @[kiṃkaraḥ], @[satāṃ] @[mataḥ] esteemed by the good; @[rājñāṃ] @[pūjitaḥ], @[idam] @[eṣām] @[āsitam] (place of sitting) @[gatam] @[śayitaṃ] वा; @[brāhmaṇasya] @[tyāga], @[narasya] @[kartavyam] &c.
...
(3)† A noun in the Genitive, used as an object in a sentence, when the agent and object of the action denoted by the nouns formed by @[kit] affixes are both used, is not compounded, as @[āścaryaṃ gavāṃ dohaścāgopena] 'the milking of cows by one, not a cowherd, is a wonder.'
