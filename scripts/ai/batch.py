"""
Batch processor for extracting all 972 rules
"""
...
class BatchProcessor:
    ...
    def __init__(
        ...
        Args:
            ...
            client: Optional Claude client (will create if not provided)
            tracker: Optional cost tracker
        """
        self.structured_pages_dir = Path(structured_pages_dir)
        self.output_dir = Path(output_dir)
        self.client = client or ClaudeClient()
        self.tracker = tracker or CostTracker(model=self.client.model)
